...
// Report type configurations with styling and metadata
...
// Main admin reports page component with comprehensive reporting functionality
const AdminReportsPage = () => {
  ...
  // Calculate date range from preset selections
  ...
  // Update applied filters display when filters change
  useEffect(() => {
  ...
  // Generate report with selected filters and date range
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      // Make API request for report data
      ...
      if (response.data.success) {
        // Ensure filters are included in response
  ...
  // Helper function to determine if field represents currency
  ...
  // Render summary cards with formatted data
  ...
  // Render actual data table with formatting
      ...
      >
        <div className="modal-dialog modal-dialog-centered" onClick={e => e.stopPropagation()}>
          <div className="modal-content filter-modal-content">
            {/* Modal header with report-specific styling */}
            ...
            <div className="modal-body filter-modal-body">
              ...
              {/* Category filters - available for all reports */}
              ...
              {/* Display options for all reports */}
              <div className="filter-section">
  ...
  // Render report type selection cards
  ...
  // Render date range selector with presets and custom options
  ...
  // Chart rendering functions for artisan reports
        ...
        <div className="ar-fixed-height-container">
          <div className="card ar-fixed-height-card">
            {!reportData ? (
              ...
              /* Report view with generated data */
