...
Inventory.hasMany(ProductImage, { foreignKey: 'product_id', sourceKey: 'product_id', as: 'productImages' });
ProductImage.belongsTo(Inventory, { foreignKey: 'product_id', targetKey: 'product_id', as: 'inventory' });
Customer.hasMany(Address, { foreignKey: 'c_id', as: 'addresses', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
Address.belongsTo(Customer, { foreignKey: 'c_id', as: 'customer' });
Order.belongsTo(Customer, { foreignKey: 'c_id', as: 'customer' });
Customer.hasMany(Order, { foreignKey: 'c_id', as: 'customerOrders', onDelete: 'SET NULL', onUpdate: 'CASCADE' });
...
app.use('/api/conversations', require('./routes/conversations/conversationRoutes'));
app.use('/api/messages', require('./routes/conversations/messageRoutes'));
...
// Port configuration and logo setup
